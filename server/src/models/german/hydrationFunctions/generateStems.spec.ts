...
describe('generateStems creates the correct stem', () => {
  const testConfig: { config: GermanVerb, expected: string }[] = [
    ...
    {
      config: {
        drop: false, hilfsverb: 'haben', infinitive: 'sammeln', languages: { en: 'to gather, to collect' }, strong: false,
      },
      expected: 'sammel',
    },
    {
      config: {
        drop: false, hilfsverb: 'haben', infinitive: 'mißsammeln', languages: { en: 'to gather, to miscollect' }, strong: false,
      },
      expected: 'mißsammel',
    },
    {
      config: {
        drop: false, hilfsverb: 'haben', infinitive: 'be|sammeln', languages: { en: 'to gather, to be causing something' }, strong: false,
      },
      expected: 'sammel',
    },
  ];
