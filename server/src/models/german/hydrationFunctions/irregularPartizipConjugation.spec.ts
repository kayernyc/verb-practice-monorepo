...
describe('irregularPartizipConjugation handles irregulars', () => {
  it('conjugates schwimmen partizip correctly', () => {
    ...
    const partizip = irregularPartizipConjugation({ stem, partizip: 'o', infinitive: 'schwimmen', weakEndings: true })
  ...
  it('conjugates bringen partizip correctly', () => {
    ...
    const partizip = irregularPartizipConjugation({ stem, infinitive: 'bringen', präteritum: 'ach', weakEndings: true })
  ...
  it('conjugates denken partizip correctly', () => {
    ...
    const partizip = irregularPartizipConjugation({ stem, infinitive: 'denken', präteritum: 'ach', weakEndings: true })
