...
describe('createVerb', () => {
  ...
  it('populates fallen correctly', () => {
    const dataObj: DataObj = { en: 'to fall', strong: true, hilfsverb: 'sein', 'stems': { 'präsens du/es': 'ä', 'k2präsens': 'iel' } };
  ...
  it('populates schwimmen correctly', () => {
    const dataObj: DataObj = { en: 'to swim', hilfsverb: 'sein', strong: true, stems: { 'partizip': 'o', 'präteritum': 'a' } };
